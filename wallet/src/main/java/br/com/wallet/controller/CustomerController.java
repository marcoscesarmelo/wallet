...
import br.com.wallet.config.JwtTokenUtil;
import br.com.wallet.exception.BusinessException;
import br.com.wallet.model.Customer;
import br.com.wallet.response.TokenResponse;
...
public class CustomerController {
	...
	public ResponseEntity<?> saveUser(@RequestBody Customer user) throws Exception {	
		try {
		    ...
		    throw new BusinessException("/register", e.getFieldName(), e.getFieldValue(), e.getMessage());			
		}
	}
